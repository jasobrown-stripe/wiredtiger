...
static const char *const __stats_dsrc_desc[] = {
  ...
  "cache: updates pages cant evict dirty",
...
__wt_stat_dsrc_clear_single(WT_DSRC_STATS *stats)
{
    ...
    stats->cache_eviction_cant_evict_dirty = 0;
...
__wt_stat_dsrc_aggregate_single(WT_DSRC_STATS *from, WT_DSRC_STATS *to)
{
    ...
    to->cache_eviction_cant_evict_dirty += from->cache_eviction_cant_evict_dirty;
...
__wt_stat_dsrc_aggregate(WT_DSRC_STATS **from, WT_DSRC_STATS *to)
{
    ...
    to->cache_eviction_cant_evict_dirty += WT_STAT_READ(from, cache_eviction_cant_evict_dirty);
